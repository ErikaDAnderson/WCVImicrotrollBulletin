...
stomachLU_orig <- list.files(path = "C:/Users/BOKVISTJ/Documents/Five Nations Reconciliation Budget/5N03 Juvenile Salmon/Juvenile CN Micro-trolling/WCVImicrotrollBulletin/",
                           pattern = "*.xlsx",
                           full.names = T) %>%
...
StatWeekLU <- read.csv("C:/Users/BOKVISTJ/Documents/Five Nations Reconciliation Budget/5N03 Juvenile Salmon/Juvenile CN Micro-trolling/WCVImicrotrollBulletin/Lookups/StatWeekLU.csv")
...
ggplot(stomach.1, aes(x=prey_description, y=CountPrey, fill=Month))+
geom_bar(stat="identity") +
  xlab("Prey item")+
    ylab("Number of fish")+
