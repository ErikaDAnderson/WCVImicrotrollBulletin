...
This section summarizes the data collected from `r overallStartDate` to `r overallEndDate`. There were `r numDaysFished` days fished (`r numBoatDaysFished` vessel days) in total within the following sounds: `r soundsSampled`. In total, there were `r ckCaught` chinook and `r coCaught` coho caught. In addition, there were `r randomSamples` random samples and `r clinicalSamples` clinical samples frozen for transport to the Pacific Biological Station. There was `r CkRecature` Chinook caught that was a recapture during this project.
...
kableExtra::kable(sumfish,
                  col.names = c("Month", "Location", "Days Fished", "AD Clipped Chinook", "AD Unclipped Chinook","Unknown Chinook", "AD Clipped Coho", "AD Unclipped Coho", "Unknown Coho", "Random", "Clinical"),
                  booktabs = TRUE,
...
View(sumfish_bycatch)

kableExtra::kable(sumfish_bycatch,
                  col.names = c("Month", "Location", "Days Fished", "Lingcod", "Pacific Herring", "Canary Rockfish", "Copper Rockfish","Quillback Rockfish", "SilverGray Rockfish", "Tiger Rockfish", "Yellowtail Rockfish", "Unknown Rockfish", "Unknown Finfish"), booktabs = TRUE, caption = "Summary of non-targeted catch") %>%
  kable_styling() %>%
...
Preliminary information on clinical signs observed in caught juvenile salmon are shown below. Clinical signs categorized as "other" in the field are further broken down with field crew's description. 
