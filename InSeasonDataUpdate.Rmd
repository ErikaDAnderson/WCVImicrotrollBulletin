...
#************************************* remove once unique keys are fixed*************************************
...
There are two maps per sound showing juvenile chinook and coho salmon catch per unit effort (salmon/hook) per fishing set. The circles are proportional to the amount of catch i.e. the more fish caught, the bigger the circles.  The black crosses represents fishing events with no catch.  
...
# modify this when data comes in
...
# # run these once with new data then comment out to knit since long
...
quatsinoMapName <- here::here("Figures", "quatsinoMap.png")

if (file.exists(quatsinoMapName)) {
knitr::include_graphics(quatsinoMapName)
} 
  

```

```{r kyuquotMap, fig.align = 'center', fig.cap = "Kyuquot Sound Catch and Fishing Effort"}
...
clayoquotMapName <- here::here("Figures", "clayoquotMap.png")

if (file.exists(clayoquotMapName)) {
knitr::include_graphics(clayoquotMapName)
} 
...
# load image
knitr::include_graphics("Data/Pacific Octopus Paralarva.jpg")
