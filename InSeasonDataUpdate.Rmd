...
# may need to crop some maps if they are inappropriately sized
# how to fix size for variable number of maps?

```

```{r quatsinoMapCK, fig.align = 'center', fig.cap = "Quatsino Sound Chinock Salmon Catch and Fishing Effort"}
...
```{r kyuquotMapCK, fig.align = 'center', fig.cap = "Kyuquot Sound Chinock Salmon Catch and Fishing Effort"}
...
```{r nootkaMapCK, fig.align = 'center', fig.cap = "Nootka Sound Chinock Salmon Catch and Fishing Effort"}
...
```{r clayoquotMapCK, fig.align = 'center', fig.cap = "Clayoquot Sound Chinock Salmon Catch and Fishing Effort"}
...
```{r barkleyMapCK, fig.align = 'center', fig.cap = "Barkley Sound Chinock Salmon Catch and Fishing Effort"}
